...
<div class="card-header border-0">
    ...
    <div class="col">
        <h3 class="mb-0">Edit médico</h3>
    </div>
    <div class="col text-right">
        <a href="{{ url('doctors') }}" class="btn btn-sm btn-default">Cancelar y regresar</a>
    </div>
    </div>
</div>
@if ($errors->any())
...
<div class="card-body">
    <form action="{{ url('/doctors/'.$doctor->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="password" class="form-control" placeholder="Ingrese un valor sólo si desea modificar la contraseña.">
        </div>
